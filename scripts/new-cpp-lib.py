...
OLD_CXX_NS = "mb::alloc_statistics"
OLD_OPT = "MB_ALLOC_STATISTICS"
OLD_INTERNAL = "_mb_alloc_statistics"
...
OLD_CMAKELISTS_HEADER = """# CMake project `mb.alloc-statistics` — options `MB_ALLOC_STATISTICS_*`, C++ `mb::alloc_statistics`, headers under `include/mb/alloc-statistics/`.
"""
...
"""
    ...
    replacements: list[tuple[str, str]] = [
        ...
        ("# alloc-statistics", f"# {args.lib_kebab}"),
        (
